...
Se generaron tres tablas distintas en la base de datos donde almacenar los resultados de los experimentos realizados: \textbf{Runs\_t} (datos relativos el entrenamiento y evaluación), \textbf{Trials\_t} (test con ensayos individuales) y \textbf{Classes\_t} (test con clases individuales de cada ensayo). Por lo tanto, las tablas generadas contienen tanto los metadatos asociados al entrenamiento como las métricas obtenidas durante su evaluación.
...
Además, también se han eliminado aquellos registros correspondientes a experimentos incompletos o interrumpidos, con el fin de garantizar la consistencia de los resultados analizados.
...
\begin{itemize}
    ...
    \item Tabla de ensayos: de 5751 registros originales se eliminaron 515, obteniéndose un total de 5246 registros válidos.
