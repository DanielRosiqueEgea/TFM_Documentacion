...
Las redes neuronales DeepConvNet y ShallowConvNet, propuestas por Schirrmeister et al. \cite{schirrmeister_DeepLearning2017} se tratan de los primeros modelos convolucionales en causar un impacto significativo en la \acrshort{eeg}. Desde entonces el uso de estas arquitecturas se ha incrementado en la literatura científica \cite{kollod_DeepComparisons2023}.




the DeepConvNet architecture was designed to be a general-purpose architecture that is not restricted to specific feature types \cite{}, and thus it serves as a more valid comparison to EEGNet.
