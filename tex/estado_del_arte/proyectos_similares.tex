...
Las estrategias descritas anteriormente constituyen la base de los distintos métodos de entrenamiento evaluados en este trabajo, los cuales buscan estudiar el impacto del método de transferenciasobre el rendimiento de modelos convolucionales aplicados a señales EEG.
