...
Finalmente, \acrshort{fbcsp} añade una etapa de selección de características para conservar aquellas con mayor capacidad discriminativa. De esta forma, el método permite seleccionar tanto los patrones espaciales como las bandas de frecuencia más relevantes para cada sujeto o tarea.

Por esto, \acrshort{fbcsp} ha sido ampliamente utilizado en sistemas \acrshort{bci} de imaginación motora, habitualmente junto con clasificadores convencionales como \textit{Naïve Bayesian Parzen Window} (NVPW) \cite{ang_FilterBank2008,ang_FilterBank2012}.

Sin embargo, a pesar de su eficacia, los métodos tradicionales de extracción de características presentan varias limitaciones importantes. Por ejemplo, al mantener la extracción y selección de características separadas de la clasificación, estos métodos requieren un conocimiento previo sobre la señal y la tarea a analizar. Esta dependencia del diseño manual de características ha motivado el uso de enfoques basados en \textit{deep learning}, capaces de aprender características discriminativas directamente a partir de los datos.
