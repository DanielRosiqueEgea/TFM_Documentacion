...
El tiempo medio de entrenamiento por iteración ha sido \(\approx\) 40 minutos, dependiendo ligeramente de la configuración del modelo y de los parámetros de entrenamiento.
