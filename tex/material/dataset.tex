...
Durante las sesiones experimentales los sujetos alternaban entre dos tareas con el objetivo de reducir la fatiga y evitar la monotonía durante la adquisición \cite{ferrero_BrainMachine2024}.:

\begin{itemize}
    \item \textit{Estática}/\textit{Static}, donde los usuarios comenzaban parados y realizaban un esfuerzo mental activo orientado a iniciar el movimiento
    \item \textit{Movimiento}/\textit{Motion}, donde la imaginación motora consistía en detener la marcha.
\end{itemize}
...
\subsubsection{Estructura y cuantificación del dataset}\label{sec:estructura_dataset}
